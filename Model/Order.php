...
class ArteDigital_PDF_Model_Order  {
	...
	public function createHtml($order){
        ...
        $html ='<div class="logo-container"><img src="logo-pdf.jpg"/></div>
<div class="invoice-header">
    Pedido #'.$order->getIncrementId() .'<br />
    '.$newDate  .'
</div><br>

<table cellspacing="0" cellpadding="0" style="border: 1px solid #808080; padding:10px; width:100% ">
    <tr valign="top">
        <td>
            <h3 style="font-size:16px; font-weight:bold;">Informações de Cobrança</h3>
...
<table class="tbl-info" style="border:1px solid #808080; padding:10px; width: 100%;" cellspacing="0" cellpadding="0">
...
<table class="items" style="width: 100%;" cellspacing="0">
    <thead>
    <tr style="border:1px solid #808080; background-color:#edebeb">
...
$html .='<table class="tbl-entrega" cellspacing="0" cellpadding="0" style="border:1px solid #808080; width:100%; padding:10px;">
