...
class ArteDigital_PDF_Model_Order  {
	...
	public function createHtml($order){
        ...
        $html ='<div class="logo-container">{{var MY_LOGO}}</div>
<div class="invoice-header">
    Pedido #'.$order->getIncrementId() .'<br />
    '.$newDate  .'
</div><br>

<table cellspacing="0" cellpadding="0" style="border-top: 1px solid #808080; padding:10px; width:100% ">
    <tr valign="top">
        <td>
...
<table class="items" style="width: 100%;" cellspacing="0">
    <thead style="style="border:1px solid #808080; background-color:#edebeb">
    <tr>
