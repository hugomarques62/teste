<?php
class ArteDigital_PDF_Model_Invoice  {


    public function createHtml($invoice){
        ...
        $html ='<div class="logo-container"><img src="http://www.easypdfinvoice.com/media/ves_pdfpros/logo_print_18.jpg"/></div>
<div class="invoice-header">
    Pedido #'.$order->getIncrementId() .'<br />
    '.$newDate  .'
</div>';
$addressShipping = $invoice->getShippingAddress();
$addressBilling = $invoice->getBillingAddress();
